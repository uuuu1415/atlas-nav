...
export async function createRepository() {
  ...
  if (config.provider === 'postgresql') return (await import('./postgresql.js')).createPostgresql(config);
  if (config.provider === 'mysql') return (await import('./mysql.js')).createMysql(config);
